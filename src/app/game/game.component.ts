  ...
  export class GameComponent implements OnInit {
    ...
    async fetchTracks(): Promise<Track[]> {
      ...
      switch (this.searchType) {
        case 'genre':
          tracks = await this.searchByGenre(this.searchQuery);
          break;
        case 'artist':
          tracks = await this.searchArtistsByName(this.searchQuery);
          break;
        case 'album':
          tracks = await this.searchByAlbumName(this.searchQuery);
          break;
      }
      return tracks;
    }
